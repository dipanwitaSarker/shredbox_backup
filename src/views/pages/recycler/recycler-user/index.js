...
import { useGetRecyclerUserList } from 'hooks/useRecycleHooks';
...
const RecyclerUser = () => {
  ...
  const [types, setTypes] = useState('Recycler');

  const { data: allRecyclerUserList, isLoading: isAllRecyclerUserDataLoading } = useGetRecyclerUserList({
    limit: rowsPerPage,
    sortOrder: order,
    sortField: orderBy,
  ...
  const handleChangePage = (event, newPage) => {
    ...
    setPage(newPage);
    // setFirstPageVal(allRecyclerUserList?.first);
    // setLastPageVal(allRecyclerUserList?.last);
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <BreadcrumbsForPage name="All Recycler Users" obj={{ title: 'All Recycler Users', title2: '', url: '' }} />
          ...
          >
            <TableContainer sx={{ maxHeight: 440 }}>
              {isAllRecyclerUserDataLoading ? (
              ...
              ) : allRecyclerUserList?.users === undefined || allRecyclerUserList?.users.length == 0 ? (
                <StyledGridOverlay>
                ...
                <Table stickyHeader aria-label="sticky table">
                  ...
                  <TableBody>
                    {stableSort(allRecyclerUserList?.users, getComparator(order, orderBy))?.map((row, i) => {
            ...
            <TablePagination
              ...
              component="div"
              count={allRecyclerUserList?.total ? allRecyclerUserList?.total : 0}
